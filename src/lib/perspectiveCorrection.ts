 ...
 *
 * 偵測照片中紙張的 4 個角（給 photoValidation 用、只做品質檢查、不變形）
 * + 提供 crop helpers（cropToCornersBounds / cropToCameraFrame）。
 *
 * 2026-05-23: 移除 applyPerspectiveTransform / correctPerspective /
 * correctPerspectiveMultiple / addPadding / computePerspectiveMatrix /
 * applyMatrix / solveLinearSystem 等變形相關 dead code。
 * UnifiedImportPage 已不再呼叫透視校正、學生 photoValidation 只做檢查。
 */

...
12. 非數學題，要求文字說明、解釋或列舉，不需計算？
    ...
    ⚠️ 以下情況必須歸為「1 題 short_answer」，**禁止**拆成多題 fill_blank 或 multi_fill：
    - 答題區有多個**帶類別標籤的格子**（如「角色①②③④」「步驟①②③④」「原因①②③④」），且格子內容是範例答案（非固定正解）
    - 格子旁標有「（答案僅供參考）」或類似備注
    - 問題為開放式提問（「你認為…」「請列出…」「會出現哪些…」），答案因人而異
    - 此類情況：referenceAnswer 填入各格答案合併說明，rubricsDimensions 以「內容完整性」「說明合理性」等維度評分

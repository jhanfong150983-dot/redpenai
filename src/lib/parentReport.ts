...
import { ALL_MATH_NODES, GUOYU_NODES, SOCIAL_NODES, SCIENCE_NODES } from '@/data/curriculumNodes'
...
只輸出 JSON：{"items":[{"questionId":"...","topic":"...","knowledgePoints":[...],"ability":"...","note":"..."}]}`
  ...
  if (isMath || isGuoyu || isSocial || isScience) {
    ...
    const pool = isMath ? ALL_MATH_NODES : isGuoyu ? GUOYU_NODES : isSocial ? SOCIAL_NODES : SCIENCE_NODES

...
const FEATURES = [
  ...
  },
  {
    tag: '檢討課',
    color: '#16a34a',
    title: '檢討單直接印在原卷上，發下去就能講',
    desc: '每個學生一份：原卷上逐題紅勾紅叉、右上角總分與錯幾題、每大題扣幾分寫在旁邊。全班合併一份 PDF 直接列印。上課開「檢討模式」投影：左邊題本、右邊這題錯幾人、誰錯了、最典型的錯法。',
    bullets: ['原卷註記版：學生對照自己的字跡，一眼看懂錯在哪', '檢討模式投影：依失分率排好順序，按 → 換下一題', '典型錯法自動聚成幾種，附學生卷面'],
    img: '/site/review-mode.jpg',
    alt: '檢討單：原卷逐題紅勾紅叉與大題扣分'
  },
  {
    tag: '學情分析',
    color: '#7c3aed',
